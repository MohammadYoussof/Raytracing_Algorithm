...
% A simple model for testing the video %%%%
%==========================================================================================
% MAIN PROGRAM
%==========================================================================================
...
color = colormap("bone"); colorbar ('horz');
...
vidfile = VideoWriter('testmovienew.mp4','MPEG-4');
open(vidfile);
...
waitbar(j/nray,wat)
   ...
   %z=sin(xh*2*pi/ind)+cos(zh*2*pi/ind);
   z=sin(xh/ind/2)+cos(zh/ind/2);
   imagesc(z),colormap("bone") 
    drawnow
    F(ind) = getframe(gcf); 
